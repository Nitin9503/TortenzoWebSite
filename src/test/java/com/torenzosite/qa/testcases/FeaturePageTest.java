...
public class FeaturePageTest extends TestBase {
	...
	public void verifyFeaturesPageTitle() throws IOException, InterruptedException {
		...
		Assert.assertEquals(featuresPage.validateFeaturesPageTitle(),
				"Mobile POS Software for Businesses, Point of Sale Hardware, Retail Management Systems - Detroit, Ann Arbor, Warren | Torenzo",
				"FeaturePage titile not found");
		...
		Assert.assertEquals(featuresPage.validateCustomReportsTitle(), "CUSTOM REPORTS",
				"CUSTOM REPORTS title not found");
	...
	public void verifyTryTorenzoForFree() throws IOException, InterruptedException {
		 ...
		 * "//a[@class='btn btn-primary btn-lg' and text()='Try Torenzo For Free']"
		...
		Assert.assertEquals(tryTorenzoForFreePage.validateTryTorenzoForFree(), "Try Torenzo for FREE today",
				"Try Torenzo for FREE today window not found upon clicking on Try Torenzo for FREE today from Feature page");
	}
	...
	public void fillFormWithEmptyData() throws IOException, InterruptedException {
		...
		Assert.assertEquals(tryTorenzoForFreePage.validateTryTorenzoForFree(), "Try Torenzo for FREE today",
				"Try Torenzo for FREE today page not found");
