	...
	public void verifyLeaveUsPageTitle() throws IOException, InterruptedException {
		...
		if (OSName.equalsIgnoreCase("Mac OS X")) {
			reader = new XlsReader(
					"/Users/rahul.kardel/Documents/TorenzoWebSite/src/main/java/com/torenzosite/qa/testdata/TorenzoWorkBook.xlsx");
		} else if (OSName.equalsIgnoreCase("Windows 10") || OSName.equalsIgnoreCase("Windows 7")) {
			reader = new XlsReader(
					"E:\\SeleniumWorkSpace\\torenzowebsite\\TorenzoWebSite\\src\\main\\java\\com\\torenzosite\\qa\\testdata\\TorenzoWorkBook.xlsx");
		...
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {
			...
			Assert.assertEquals(leaveUsPage.validateLeaveUsMessageTitle(), "Support",
					"Leave Us Message Page Not not found upon clicking on Leave Us Message");
			Thread.sleep(5000);
			...
			if (rowNum == 2) {
				...
				Assert.assertEquals(contactUsPage.validateThankYouPageTitle(),
						...
						"Thank You Page Title not found after failing form and clicking on Submit");
...
/*
 * @Test(priority=13) public void closeToForm() throws IOException,
 * InterruptedException{
 * 
 * leaveUsPage = homePage.ClickOnLeaveUsaMessage();
 * 
 * Thread.sleep(5000); System.out.println("Title==>"
 * +leaveUsPage.validateLeaveUsMessageTitle());
 * Assert.assertEquals(leaveUsPage.validateLeaveUsMessageTitle(), "Support",
 * "Leave Us Message Page Not not found upon clicking on Leave Us Message");
 * 
 * leaveUsPage.clickOnClose(); }
 ...
 * 
 * 
 * leaveUsPage = homePage.ClickOnLeaveUsaMessage(); Thread.sleep(3000);
 * System.out.println("Title==>" +leaveUsPage.validateLeaveUsMessageTitle());
 * Assert.assertEquals(leaveUsPage.validateLeaveUsMessageTitle(), "Support",
 * "Leave Us Message Page Not not found upon clicking on Leave Us Message");
 * leaveUsPage.passFirstName("Sachin");
 * leaveUsPage.passEmailID("sachin.patil.uk@gmail.com");
 * leaveUsPage.passPhoneNo("9552619077"); leaveUsPage.passMessage("Hello");
 * leaveUsPage.clickOnSubmit(); Thread.sleep(8000);
 * Assert.assertEquals(contactUsPage.validateThankYouPageTitle(),
 * "Thank You! - Detroit, Ann Arbor, Warren | Torenzo",
 * "Thank You Page Title not found after failing form and clicking on Submit");
 * System.out.println("Done"); }
 * 
 * @Test(priority=14) public void fillFormWithEmptyDataLeaveUsMessage() throws
 ...
 * Assert.assertEquals(leaveUsPage.validateLeaveUsMessageTitle(), "Support",
 * "Leave Us Message Page Not not found upon clicking on Leave Us Message");
 * leaveUsPage.clickOnSubmit(); System.out.println("Alert Message ==>"
 * +contactUsPage.getTextFromAlertMessage());
 * Assert.assertEquals(contactUsPage.getTextFromAlertMessage(),
 * "There was a problem with your submission. Errors have been highlighted below."
 * ,"Validation message is missing as keeping all field empty");
 * System.out.println("Done"); System.out.println("Validation Message ==>"
 * +contactUsPage.getTextFromValidationMessage());
 * Assert.assertEquals(contactUsPage.getTextFromValidationMessage(),
 ...
 * }
 * 
 * @Test(priority=15) public void fillFormWithEmptyName() throws IOException,
 * InterruptedException{
 * 
 * leaveUsPage = homePage.ClickOnLeaveUsaMessage(); Thread.sleep(3000);
 * System.out.println("Title==>" +leaveUsPage.validateLeaveUsMessageTitle());
 ...
 * leaveUsPage.passEmailID("sachin.patil.uk@gmail.com");
 * leaveUsPage.passPhoneNo("9552619077"); leaveUsPage.passMessage("Hello");
 * leaveUsPage.clickOnSubmit(); Thread.sleep(8000); System.out.println(
 * "Alert Message ==>" +contactUsPage.getTextFromAlertMessage());
 * Assert.assertEquals(contactUsPage.getTextFromAlertMessage(),
 * "There was a problem with your submission. Errors have been highlighted below."
 * ,"Validation message is missing as keeping all field empty");
 * System.out.println("Done"); System.out.println("Validation Message ==>"
 ...
 * }
 * 
 * @Test(priority=16) public void fillFormWithEmptyEmailId() throws IOException,
 * InterruptedException{
 * 
 * leaveUsPage = homePage.ClickOnLeaveUsaMessage(); Thread.sleep(3000);
 * System.out.println("Title==>" +leaveUsPage.validateLeaveUsMessageTitle());
 ...
 * }
 * 
 * @Test(priority=17) public void fillFormWithEmptyPhoneNumber() throws
 * IOException, InterruptedException{
 * 
 * leaveUsPage = homePage.ClickOnLeaveUsaMessage(); Thread.sleep(3000);
 * System.out.println("Title==>" +leaveUsPage.validateLeaveUsMessageTitle());
 ...
 * 
 * 
 * @Test(priority=18) public void fillFormWithEmptyMessage() throws IOException,
 * InterruptedException{
 * 
 * leaveUsPage = homePage.ClickOnLeaveUsaMessage(); Thread.sleep(3000);
 * System.out.println("Title==>" +leaveUsPage.validateLeaveUsMessageTitle());
 ...
 * }
 * 
 * @Test(priority=19) public void fillFormWithIncorrectEmilId() throws
 * IOException, InterruptedException{
 * 
 * leaveUsPage = homePage.ClickOnLeaveUsaMessage(); Thread.sleep(3000);
 * System.out.println("Title==>" +leaveUsPage.validateLeaveUsMessageTitle());
 * Assert.assertEquals(leaveUsPage.validateLeaveUsMessageTitle(), "Support",
 * "Leave Us Message Page Not not found upon clicking on Leave Us Message");
 * leaveUsPage.passFirstName("Sachin"); leaveUsPage.passEmailID("sachi@@12");
 * leaveUsPage.passPhoneNo("9552619077"); leaveUsPage.passMessage("Hello");
 * leaveUsPage.clickOnSubmit(); Thread.sleep(8000); System.out.println(
 * "Alert Message ==>" +contactUsPage.getTextFromAlertMessage());
 * Assert.assertEquals(contactUsPage.getTextFromAlertMessage(),
