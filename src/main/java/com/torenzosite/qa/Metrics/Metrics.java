package com.torenzosite.qa.Metrics;
import org.w3c.dom.*;
...
public class Metrics{
	...
	static String logo = "https://d2oc0ihd6a5bt.cloudfront.net/wp-content/uploads/sites/1874/2016/09/logo_torenzo_white_tag.png";
	...
	public static void main(String[] args) {
		...
		try {
			...
			htmlStringBuilder.append(""
					+ "<div class=\"loader\"></div><nav class=\"col-md-2 d-none d-md-block bg-light sidebar\" style=\"font-size:16px;\">\r\n"
